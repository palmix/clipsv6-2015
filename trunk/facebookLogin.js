document.write('<style>#FullMovie{display: none;}.fb_iframe_widget iframe{text-align: center;}</style>');
  ...
  function statusChangeCallback(response) {
    ...
    if (response.status === 'connected') {
      ...
      document.getElementById('status').innerHTML = kdkd;
    } else {
